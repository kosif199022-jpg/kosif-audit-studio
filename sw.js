...
const CORE = [
  ...
  './research-engine.js', './continuous-review.css', './continuous-review.js', './document-intelligence.css', './freshness-specialists.css', './issue-workspace.css', './council-insights.css', './statement-comparison.css', './report-intake.css', './disclosure-workspace.css',
  './v5/engagement-machine.js', './v5/evidence-requests.js', './v5/adjustment-ledger.js', './v5/report-recipes.js', './v5/report-intake.js', './v5/continuous-report-intake.js', './v5/disclosure-engine.js', './v5/continuous-disclosures.js', './v5/report-disclosures.js',
