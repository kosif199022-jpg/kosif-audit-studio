const CACHE = 'kosif-audit-studio-v5.0.0';
const CORE = [
  ...
  './research-engine.js', './continuous-review.css', './continuous-review.js', './document-intelligence.css', './freshness-specialists.css', './issue-workspace.css', './council-insights.css', './statement-comparison.css', './statement-lineage.css', './report-intake.css', './cash-flow-workspace.css', './equity-workspace.css', './disclosure-workspace.css', './report-publication.css', './trace-inspector.css', './workspace-navigation.css', './dashboard-capabilities.css', './dashboard-navigation-theme.css', './dashboard-theme.css', './kosif-heritage-v5.css', './kosif-assistant.css',
  './v5/engagement-machine.js', './v5/evidence-requests.js', './v5/adjustment-ledger.js', './v5/report-recipes.js', './v5/report-intake.js', './v5/continuous-report-intake.js', './v5/cash-flow-engine.js', './v5/cash-flow-workflow.js', './v5/continuous-cash-flow.js', './v5/report-cash-flow.js', './v5/equity-engine.js', './v5/equity-workflow.js', './v5/continuous-equity.js', './v5/report-equity.js', './v5/disclosure-engine.js', './v5/continuous-disclosures.js', './v5/report-disclosures.js',
  './v5/traceability.js', './v5/trace-inspector.js', './v5/continuous-trace-inspector.js', './v5/review-loop.js', './v5/document-client.js', './v5/document-intelligence.js', './v5/audit-coverage.js', './v5/continuous-coverage.js', './v5/statement-comparison.js', './v5/statement-lineage.js', './v5/continuous-statements.js', './v5/continuous-statement-lineage.js',
  './v5/continuous-store.js', './v5/continuous-documents.js', './v5/continuous-council.js', './v5/continuous-issues.js', './v5/issue-workflow.js', './v5/continuous-reporting.js', './v5/report-publication.js', './v5/continuous-publication.js', './v5/workspace-layout.js', './v5/continuous-workspace-navigation.js', './v5/ui-assets.js',
  './v5/dashboard-capabilities.js', './v5/restore-points.js', './v5/spreadsheet-intake.js', './v5/continuous-spreadsheet-intake.js', './v5/continuous-dashboard.js', './v5/continuous-assistant.js', './v5/dashboard-suite.js',
