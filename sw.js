...
const CORE = [
  ...
  './v5/dashboard-capabilities.js', './v5/restore-points.js', './v5/spreadsheet-intake.js', './v5/continuous-spreadsheet-intake.js', './v5/continuous-dashboard.js', './v5/dashboard-suite.js',
