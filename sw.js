...
const CORE = [
  ...
  './research-engine.js', './continuous-review.css', './continuous-review.js', './document-intelligence.css', './freshness-specialists.css', './issue-workspace.css', './council-insights.css', './statement-comparison.css', './report-intake.css', './cash-flow-workspace.css', './equity-workspace.css', './disclosure-workspace.css', './report-publication.css', './trace-inspector.css',
  ...
  './v5/traceability.js', './v5/trace-inspector.js', './v5/continuous-trace-inspector.js', './v5/review-loop.js', './v5/document-client.js', './v5/document-intelligence.js', './v5/audit-coverage.js', './v5/continuous-coverage.js', './v5/statement-comparison.js', './v5/continuous-statements.js',
  './v5/continuous-store.js', './v5/continuous-documents.js', './v5/continuous-council.js', './v5/continuous-issues.js', './v5/issue-workflow.js', './v5/continuous-reporting.js', './v5/report-publication.js', './v5/continuous-publication.js',
