...
const legacyLink=document.querySelector('.top-actions a.ghost');if(legacyLink){legacyLink.href='./index.html?legacy=1';legacyLink.textContent='فتح KOSIF 4 القديم'}
